    ...
    >
      <div className="relative flex w-full flex-1 scale-y-50 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-28 overflow-visible w-[15rem] bg-gradient-conic from-yellow-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-28 w-[15rem] bg-gradient-conic from-transparent via-transparent to-yellow-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-18 w-[14rem] -translate-y-1/2 rounded-full bg-yellow-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "4rem" }}
          ...
          className="absolute inset-auto z-30 h-18 w-32 -translate-y-[3rem] rounded-full bg-yellow-400 blur-2xl"
        ></motion.div>
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[15rem] -translate-y-[3.5rem] bg-yellow-400 "
        ></motion.div>
