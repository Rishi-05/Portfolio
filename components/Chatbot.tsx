...
export default function EnhancedChatbot() {
  ...
  const getAudioForText = async (text: string): Promise<string | undefined> => {
    try {
      const response = await axios.post(
        'https://rishi-chilveri.vercel.app/text-to-speech',
        { text },
        { responseType: 'blob' }
      )
  ...
  const chatWithLlama = async () => {
    ...
    try {
      setIsLoading(true)
      const response = await axios.post('https://rishi-chilveri.vercel.app/chat', {
  ...
  const startSession = async () => {
    try {
      setIsLoading(true)
      const response = await axios.post('https://rishi-chilveri.vercel.app/start_session', {
        resumeContent
      })
      setChatOpen(true)
  ...
  const endSession = async () => {
    try {
      await axios.post('https://rishi-chilveri.vercel.app/end_session')
